      ...
      >
        ...
        <section
          className={`grid min-h-0 flex-1 ${
            keyboardOpen ? "items-start gap-4 sm:gap-6 lg:items-center lg:gap-14" : "items-center gap-6 sm:gap-8 lg:gap-14"
          } lg:grid-cols-[0.44fr_0.56fr]`}
        >
          <div className={`flex min-h-0 flex-col ${keyboardOpen ? "justify-start gap-3" : "justify-center gap-5 lg:gap-6"}`}>
              ...
              <div className="max-w-[31rem] space-y-3">
                <h1
                  className={`font-display font-semibold leading-[0.94] tracking-[-0.06em] text-text ${
                    keyboardOpen ? "text-[32px] sm:text-[44px] lg:text-[68px]" : "text-[40px] sm:text-[52px] lg:text-[68px]"
                  }`}
                >
            ...
            <div className={`flex flex-wrap gap-2 lg:hidden ${keyboardOpen ? "hidden sm:flex" : ""}`}>
          ...
          <div className={`flex min-h-0 h-full ${keyboardOpen ? "items-start" : "items-center"} lg:justify-end`}>
            <div className="surface-panel w-full rounded-[30px] p-4 sm:p-5 lg:max-w-[37rem] lg:rounded-[34px] lg:p-6">
              <div className={`${keyboardOpen ? "space-y-3" : "space-y-4"}`}>
                <div className="grid grid-cols-[1fr_auto] items-center gap-3 rounded-[24px] border hairline bg-[#FBFAF7] p-3 sm:p-4">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div className="space-y-2.5">
                    ...
                    <textarea
                      ...
                      className="w-full resize-none rounded-[26px] border hairline bg-[#FBFAF7] px-5 py-4 text-[17px] leading-7 tracking-[-0.01em] text-text outline-none transition placeholder:text-black/28 focus:border-[#D8D1C6] focus:bg-white"
                    />
                  </div>
